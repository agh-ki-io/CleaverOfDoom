 ...
 */
public class EnemyFinalAnnihilationSkill extends Skill {
...
//    private final FireEffect effect;
    ...
    public EnemyFinalAnnihilationSkill(Level level, pl.edu.agh.game.logic.entities.Character skillUser) {
        super(level, skillUser);
        effect = new StaticShapedEffect(skillUser.getX(), skillUser.getY(), 300, 16, 0.2f, new FireEffect(5, true));
        attack = new StaticShapedAttack(skillUser.getX(), skillUser.getY(), 4 * 4, new Damage(DamageType.PHYSICAL, 9000000), 16, 0.2f);
